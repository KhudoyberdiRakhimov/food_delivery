...
// @route    GET api/auth/visitor
// @desc     Get visitor by token
// @access   Private
router.get('/visitor', authV, async (req, res) => {
  try {
...
// @route    POST api/auth/visitor
// @desc     Authenticate visitor & get token
// @access   Public
router.post(
  '/visitor',
  [
